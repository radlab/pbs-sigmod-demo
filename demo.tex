...
\subfigure[Mobile Web App]{\includegraphics[width=.22\textwidth]{figs/phone.pdf}\label{fig:app}}
\subfigure[DBA and Query Tuning Dashboard]{\includegraphics[width=.38\textwidth]{figs/dash.pdf}\label{fig:dash}}
\subfigure[Chaos Console]{\includegraphics[width=.39\textwidth]{figs/chaos.pdf}\label{fig:chaos}}
