...
\subfigure[Mobile Web App]{\includegraphics[width=.20\textwidth]{figs/phone.pdf}}
\subfigure[DBA and Query Tuning Dashboard]{\includegraphics[width=.39\textwidth]{figs/dash.pdf}}
\subfigure[Chaos Console]{\includegraphics[width=.4\textwidth]{figs/chaos.pdf}}
